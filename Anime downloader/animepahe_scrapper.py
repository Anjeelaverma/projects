...
# Headers and cookies, you'll need to provide the cookies manually
headers = {
...
# Provide your cookie manually
cookies = {
    "cookie": "__ddgid_=2SrXH4fExTS5qhPJ; __ddg2_=2090DRsKroUuSv5k; __ddg1_=DxVHHUGrxHxwrNzRVFrS; SERVERID=janna; aud=jpn; av1=0; res=1080; latest=5628; ann-fakesite=0; XSRF-TOKEN=your_token_here; laravel_session=your_session_here"
}

def get_query(query: str):
    url = f'https://animepahe.ru/api?m=search&q={query}'
    response = r.get(url, headers=headers, cookies=cookies).json()
    results = {}
